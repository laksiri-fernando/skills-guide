---
description: Use this skill when the user wants to write a daily standup, scrum update, or team status message. Trigger on phrases like "write my standup", "daily update", "what did I work on", or "team update". Use this even if they just say "standup" casually.
metadata:
    github-path: standup-writer
    github-ref: refs/heads/main
    github-repo: https://github.com/laksiri-fernando/skills-guide
    github-tree-sha: bfc8e92f422ec2403403362b1e94e30a4b7a4eb1
name: standup-writer
---
# Standup Writer
